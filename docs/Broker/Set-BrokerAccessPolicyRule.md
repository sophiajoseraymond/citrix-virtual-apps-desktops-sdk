...
For a detailed description of this property see "help [about\_Broker\_AccessPolicy](../about_Broker_AccessPolicy/)". | false | false |  |
...
| AllowedUsers | Changes the behavior of the included users filter of the rule. This can restrict access to a list of named users or groups, allow access to any authenticated user, any user (whether authenticated or not), or only non-authenticated users. For a detailed description of this property see "help [about\_Broker\_AccessPolicy](../about_Broker_AccessPolicy/)".  
