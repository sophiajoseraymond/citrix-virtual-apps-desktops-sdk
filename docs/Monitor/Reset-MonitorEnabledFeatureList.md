...
```
Reset-MonitorEnabledFeatureList [-BearerToken <String>] [-TraceParent <String>] [-TraceState <String>] [-VirtualSiteId <String>] [-AdminAddress <String>] [<CommonParameters>]
```
...
If the command fails, the following errors can be returned. Error Codes  
    ...
    ExceptionThrown  
        An unexpected error occurred.  For more details, see the Windows event logs on the controller or the Virtual Apps and Desktops logs.
## Examples
